...
namespace TopSunday.Controllers
{
    public class GameController : Controller
    {
        ...
        public ActionResult SundayStats()
        {
            ...
            listSunday = db.Classification.Where(x => x.GameDay.Description.Equals("Sunday")).ToList<Classification>();
            listWednesday = db.Classification.Where(x => x.GameDay.Description.Equals("Wednesday")).ToList<Classification>();
